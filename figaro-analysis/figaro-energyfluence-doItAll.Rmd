...
data=tibble(iX=numeric(),iY=numeric(),iZ=numeric(),Emin=numeric(),Emax=numeric(),value=numeric())
temp=data
for(i in 1:length(fileNames)){
  ...
  temp$iZ=as.numeric(regex[[1]][2])
  temp=select(temp,iX,iY,iZ,value)
  temp=mutate(temp,Emin=as.numeric(regex[[1]][3]))
  temp=mutate(temp,Emax=as.numeric(regex[[1]][4]))
...
currentSource=summarise(group_by(data,iX,iY,iZ,Emin,Emax),value=sum(value))
