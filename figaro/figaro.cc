...
//
// Modified for FIGARO: lindbohansen@gmail.com 07/2017
...
{  
  ...
  //
  auto detConstruction = new figaroDetectorConstruction();
  runManager->SetUserInitialization(detConstruction);

  auto physicsList = new QGSP_BERT_HP;
  runManager->SetUserInitialization(physicsList);

  auto actionInitialization = new figaroActionInitialization();
