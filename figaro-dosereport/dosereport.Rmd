...
Setups received the following accumulated absorbed doses (accumulated_Gy), at the following average (avg_mGyperh), minimum (min_mGyperh) and maximum (max_mGyperh) absorbed dose rates.
