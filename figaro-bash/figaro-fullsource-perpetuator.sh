...
then
	...
	echo "3. Run FIGARO via a macro"
        echo "4. Run FIGARO via a macro perpetually (until I tell it to stop)"
	echo "5. Copy timestamped FIGARO results to the results folder"
	echo "6. Analyse FIGARO output"
	...
	case $choice in
		...
		if [ -f $macroName ]
		then  
		  echo "Cool! I'll run FIGARO while you go get a coffee."
		  sleep 1.5
		...
		then
		  ...
		  echo "Alright! I'll stay here and run FIGARO perpetually."
	    ...
	    9)
		clear
		echo "The FIGARO Perpetuator has exited. Goodbye!"
		exit 0
		;;
	    *)
